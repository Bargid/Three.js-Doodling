...
var POSTPROCESSING = (() => {
  ...
  var import_Timer = __require("three/examples/jsm/misc/Timer.js");
  ...
  // src/materials/BoxBlurMaterial.js
  var BoxBlurMaterial = class extends import_three3.ShaderMaterial {
    /**
    ...
    constructor({ bilateral = false, kernelSize = 5 } = {}) {
      super({
        ...
        uniforms: {
          ...
          normalDepthBuffer: new import_three3.Uniform(null),
          texelSize: new import_three3.Uniform(new import_three3.Vector2()),
          cameraNearFar: new import_three3.Uniform(new import_three3.Vector2()),
          scale: new import_three3.Uniform(1)
        },
  ...
  var TiltShiftBlurMaterial = class extends KawaseBlurMaterial {
    ...
    constructor({
      ...
      this.kernelSize = kernelSize;
      this.uniforms.aspect = new import_three21.Uniform(1);
      this.uniforms.rotation = new import_three21.Uniform(new import_three21.Vector2());
      this.uniforms.maskParams = new import_three21.Uniform(new import_three21.Vector4());
      this._offset = offset;
  ...
  // src/materials/UpsamplingMaterial.js
  var UpsamplingMaterial = class extends import_three22.ShaderMaterial {
    /**
    ...
    constructor() {
      super({
        ...
        uniforms: {
          inputBuffer: new import_three22.Uniform(null),
          supportBuffer: new import_three22.Uniform(null),
          texelSize: new import_three22.Uniform(new import_three22.Vector2()),
          radius: new import_three22.Uniform(0.85)
        },
        blending: import_three22.NoBlending,
        toneMapped: false,
        depthWrite: false,
        depthTest: false,
  ...
  var dummyCamera = /* @__PURE__ */ new import_three23.Camera();
  var geometry = null;
  function getFullscreenTriangle() {
    if (geometry === null) {
      const vertices = new Float32Array([-1, -1, 0, 3, -1, 0, -1, 3, 0]);
      const uvs = new Float32Array([0, 0, 2, 0, 0, 2]);
      geometry = new import_three23.BufferGeometry();
      if (geometry.setAttribute !== void 0) {
        geometry.setAttribute("position", new import_three23.BufferAttribute(vertices, 3));
        geometry.setAttribute("uv", new import_three23.BufferAttribute(uvs, 2));
      } else {
        geometry.addAttribute("position", new import_three23.BufferAttribute(vertices, 3));
        geometry.addAttribute("uv", new import_three23.BufferAttribute(uvs, 2));
      }
    }
    return geometry;
  }
  var Pass = class _Pass {
     ...
     */
    constructor(name = "Pass", scene = new import_three23.Scene(), camera = dummyCamera) {
      this.name = name;
      this.renderer = null;
      this.scene = scene;
      this.camera = camera;
    ...
    set fullscreenMaterial(value) {
      ...
      if (screen !== null) {
        ...
        screen = new import_three23.Mesh(getFullscreenTriangle(), value);
     ...
     */
    setDepthTexture(depthTexture, depthPacking = import_three23.BasicDepthPacking) {
    }
    /**
     * Renders this pass.
     *
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        ...
        const isDisposable = property instanceof import_three23.WebGLRenderTarget || property instanceof import_three23.Material || property instanceof import_three23.Texture || property instanceof _Pass;
        if (isDisposable) {
          this[key].dispose();
        }
      }
  ...
  var CopyPass = class extends Pass {
    ...
    constructor(renderTarget, autoResize = true) {
      ...
      if (renderTarget === void 0) {
        this.renderTarget = new import_three24.WebGLRenderTarget(1, 1, {
          minFilter: import_three24.LinearFilter,
          magFilter: import_three24.LinearFilter,
          stencilBuffer: false,
          depthBuffer: false
        });
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        if (frameBufferType !== import_three24.UnsignedByteType) {
          this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
        } else if (renderer.outputColorSpace === import_three24.SRGBColorSpace) {
          this.renderTarget.texture.colorSpace = import_three24.SRGBColorSpace;
        }
      }
    }
  };
  ...
  var AdaptiveLuminancePass = class extends Pass {
    ...
    constructor(luminanceBuffer, { minLuminance = 0.01, adaptationRate = 1 } = {}) {
      ...
      this.needsSwap = false;
      this.renderTargetPrevious = new import_three25.WebGLRenderTarget(1, 1, {
  ...
  var BoxBlurPass = class extends Pass {
    ...
    constructor({
      ...
      this.renderTargetA = new import_three26.WebGLRenderTarget(1, 1, { depthBuffer: false });
      this.renderTargetA.texture.name = "Blur.Target.A";
      this.renderTargetB = new import_three26.WebGLRenderTarget(1, 1, { depthBuffer: false });
     ...
     * @param {DepthPackingStrategies} [depthPacking=BasicDepthPacking] - The depth packing strategy.
     */
    setDepthTexture(depthTexture, depthPacking = import_three26.BasicDepthPacking) {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (frameBufferType !== import_three26.UnsignedByteType) {
          this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
        } else if (renderer.outputColorSpace === import_three26.SRGBColorSpace) {
          this.renderTargetA.texture.colorSpace = import_three26.SRGBColorSpace;
          this.renderTargetB.texture.colorSpace = import_three26.SRGBColorSpace;
        }
      }
    }
  };
  ...
  var color = /* @__PURE__ */ new import_three27.Color();
...
`;
      ...
      if (mainImageExists) {
        if (effect.inputColorSpace !== null && effect.inputColorSpace !== data.colorSpace) {
          fragmentMainImage += effect.inputColorSpace === import_three32.SRGBColorSpace ? "color0 = LinearTosRGB(color0);\n	" : "color0 = sRGBToLinear(color0);\n	";
        }
        if (effect.outputColorSpace !== import_three32.NoColorSpace) {
...
`;
  ...
  var EffectPass = class extends Pass {
    ...
    updateMaterial() {
      ...
      if (data.colorSpace === import_three32.SRGBColorSpace) {
  ...
  var GaussianBlurPass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        } else if (renderer.outputColorSpace === import_three33.SRGBColorSpace) {
          this.renderTargetA.texture.colorSpace = import_three33.SRGBColorSpace;
          this.renderTargetB.texture.colorSpace = import_three33.SRGBColorSpace;
        }
      }
    }
  };
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        if (frameBufferType !== import_three34.UnsignedByteType) {
          this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
          this.copyMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
        } else if (renderer.outputColorSpace === import_three34.SRGBColorSpace) {
  ...
  var MipmapBlurPass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        } else if (renderer.outputColorSpace === import_three36.SRGBColorSpace) {
          for (const mipmap of mipmaps) {
            mipmap.texture.colorSpace = import_three36.SRGBColorSpace;
          }
        }
      }
    }
  ...
  var NormalPass = class extends Pass {
    ...
    constructor(scene, camera, {
      ...
      clearPass.overrideClearColor = new import_three37.Color(7829503);
      clearPass.overrideClearAlpha = 1;
      this.renderTarget = renderTarget;
      if (this.renderTarget === void 0) {
  ...
  var EffectComposer = class {
    ...
    constructor(renderer = null, {
      ...
      this.passes = [];
      this.timer = new import_Timer.Timer();
    ...
    setRenderer(renderer) {
      ...
      if (renderer !== null) {
        ...
        if (frameBufferType === import_three39.UnsignedByteType && renderer.outputColorSpace === import_three39.SRGBColorSpace) {
          this.inputBuffer.texture.colorSpace = import_three39.SRGBColorSpace;
          this.outputBuffer.texture.colorSpace = import_three39.SRGBColorSpace;
          this.inputBuffer.dispose();
          this.outputBuffer.dispose();
        }
    ...
    createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
      ...
      const renderTarget = new import_three39.WebGLRenderTarget(size.width, size.height, options);
      if (multisampling > 0) {
        renderTarget.ignoreDepthForMultisampleCopy = false;
        renderTarget.samples = multisampling;
      }
      if (type === import_three39.UnsignedByteType && renderer.outputColorSpace === import_three39.SRGBColorSpace) {
        renderTarget.texture.colorSpace = import_three39.SRGBColorSpace;
      }
    ...
    setSize(width, height, updateStyle) {
      const renderer = this.renderer;
      const currentSize = renderer.getSize(new import_three39.Vector2());
  ...
  var Effect = class extends import_three44.EventDispatcher {
    ...
    constructor(name, fragmentShader, {
      ...
      this._inputColorSpace = import_three44.LinearSRGBColorSpace;
      this._outputColorSpace = import_three44.NoColorSpace;
    }
    /**
  ...
  var BloomEffect = class extends Effect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
        if (renderer.outputColorSpace === import_three45.SRGBColorSpace) {
          this.renderTarget.texture.colorSpace = import_three45.SRGBColorSpace;
        }
      }
    }
  };
  ...
  var BrightnessContrastEffect = class extends Effect {
    ...
    constructor({ blendFunction = BlendFunction.SRC, brightness = 0, contrast = 0 } = {}) {
      ...
      this.inputColorSpace = import_three47.SRGBColorSpace;
    }
    /**
     * The brightness.
     *
  ...
  var DepthOfFieldEffect = class extends Effect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer.outputColorSpace === import_three50.SRGBColorSpace) {
          this.renderTarget.texture.colorSpace = import_three50.SRGBColorSpace;
          this.renderTargetNear.texture.colorSpace = import_three50.SRGBColorSpace;
          this.renderTargetFar.texture.colorSpace = import_three50.SRGBColorSpace;
  ...
  var LookupTexture = class _LookupTexture extends import_three53.Data3DTexture {
    ...
    constructor(data, size) {
      ...
      this.needsUpdate = true;
      this.colorSpace = import_three53.LinearSRGBColorSpace;
    ...
    convertLinearToSRGB() {
      ...
      if (this.type === import_three53.FloatType) {
        ...
        this.colorSpace = import_three53.SRGBColorSpace;
        this.needsUpdate = true;
      } else {
  ...
  var GodRaysEffect = class extends Effect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer.outputColorSpace === import_three57.SRGBColorSpace) {
          this.renderTargetA.texture.colorSpace = import_three57.SRGBColorSpace;
          this.renderTargetB.texture.colorSpace = import_three57.SRGBColorSpace;
          this.renderTargetLight.texture.colorSpace = import_three57.SRGBColorSpace;
        }
      }
    }
  };
  ...
  var LUT3DEffect = class extends Effect {
    ...
    constructor(lut, {
      ...
      inputColorSpace = import_three62.SRGBColorSpace
    } = {}) {
  ...
  var SelectiveBloomEffect = class extends BloomEffect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        this.renderTargetMasked.texture.type = frameBufferType;
        if (renderer.outputColorSpace === import_three68.SRGBColorSpace) {
          this.renderTargetMasked.texture.colorSpace = import_three68.SRGBColorSpace;
        }
      }
    }
  };
  ...
  var TiltShiftEffect = class extends Effect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
        if (renderer.outputColorSpace === import_three73.SRGBColorSpace) {
          this.renderTarget.texture.colorSpace = import_three73.SRGBColorSpace;
        }
      }
    }
  };

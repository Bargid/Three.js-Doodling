...
import {
  ...
  SRGBColorSpace as SRGBColorSpace7,
...
import { BasicDepthPacking as BasicDepthPacking5, NoBlending as NoBlending12, REVISION, ShaderMaterial as ShaderMaterial12, Uniform as Uniform12, Vector2 as Vector27 } from "three";
...
import { BasicDepthPacking as BasicDepthPacking6, NoBlending as NoBlending13, PerspectiveCamera as PerspectiveCamera5, REVISION as REVISION2, ShaderMaterial as ShaderMaterial13, Uniform as Uniform13, Vector2 as Vector28 } from "three";
...
import { NoBlending as NoBlending16, REVISION as REVISION3, ShaderMaterial as ShaderMaterial16, Uniform as Uniform16 } from "three";
...
import { LinearFilter, SRGBColorSpace, UnsignedByteType as UnsignedByteType2, WebGLRenderTarget as WebGLRenderTarget2 } from "three";
...
import { BasicDepthPacking as BasicDepthPacking9, SRGBColorSpace as SRGBColorSpace2, UnsignedByteType as UnsignedByteType3, WebGLRenderTarget as WebGLRenderTarget4 } from "three";
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      ...
      if (frameBufferType !== UnsignedByteType3) {
        this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      } else if (renderer.outputColorSpace === SRGBColorSpace2) {
        this.renderTargetA.texture.colorSpace = SRGBColorSpace2;
        this.renderTargetB.texture.colorSpace = SRGBColorSpace2;
      }
    }
  }
};
...
import { BasicDepthPacking as BasicDepthPacking12, NoColorSpace, SRGBColorSpace as SRGBColorSpace3, UnsignedByteType as UnsignedByteType5 } from "three";
...
`;
    ...
    if (mainImageExists) {
      if (effect.inputColorSpace !== null && effect.inputColorSpace !== data.colorSpace) {
        fragmentMainImage += effect.inputColorSpace === SRGBColorSpace3 ? "color0 = LinearTosRGB(color0);\n	" : "color0 = sRGBToLinear(color0);\n	";
      }
...
var EffectPass = class extends Pass {
  ...
  updateMaterial() {
    ...
    if (data.colorSpace === SRGBColorSpace3) {
...
import { SRGBColorSpace as SRGBColorSpace4, UnsignedByteType as UnsignedByteType6, WebGLRenderTarget as WebGLRenderTarget8 } from "three";
var GaussianBlurPass = class extends Pass {
  ...
  initialize(renderer, alpha, frameBufferType) {
    if (frameBufferType !== void 0) {
      ...
      } else if (renderer.outputColorSpace === SRGBColorSpace4) {
        this.renderTargetA.texture.colorSpace = SRGBColorSpace4;
        this.renderTargetB.texture.colorSpace = SRGBColorSpace4;
      }
    }
  }
};
...
import { SRGBColorSpace as SRGBColorSpace5, UnsignedByteType as UnsignedByteType7, WebGLRenderTarget as WebGLRenderTarget9 } from "three";
  ...
  initialize(renderer, alpha, frameBufferType) {
    if (frameBufferType !== void 0) {
      ...
      if (frameBufferType !== UnsignedByteType7) {
        this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
        this.copyMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      } else if (renderer.outputColorSpace === SRGBColorSpace5) {
        this.renderTargetA.texture.colorSpace = SRGBColorSpace5;
        this.renderTargetB.texture.colorSpace = SRGBColorSpace5;
      }
    }
  }
  /**
...
import { SRGBColorSpace as SRGBColorSpace6, UnsignedByteType as UnsignedByteType9, Vector2 as Vector215, WebGLRenderTarget as WebGLRenderTarget11 } from "three";
var MipmapBlurPass = class extends Pass {
  ...
  initialize(renderer, alpha, frameBufferType) {
    if (frameBufferType !== void 0) {
      ...
      } else if (renderer.outputColorSpace === SRGBColorSpace6) {
        for (const mipmap of mipmaps) {
          mipmap.texture.colorSpace = SRGBColorSpace6;
        }
      }
    }
  }
...
var EffectComposer = class {
  ...
  setRenderer(renderer) {
    ...
    if (renderer !== null) {
      ...
      if (frameBufferType === UnsignedByteType11 && renderer.outputColorSpace === SRGBColorSpace7) {
        this.inputBuffer.texture.colorSpace = SRGBColorSpace7;
        this.outputBuffer.texture.colorSpace = SRGBColorSpace7;
        this.inputBuffer.dispose();
        this.outputBuffer.dispose();
      }
  ...
  createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
    ...
    if (type === UnsignedByteType11 && renderer.outputColorSpace === SRGBColorSpace7) {
      renderTarget.texture.colorSpace = SRGBColorSpace7;
    }
...
import { SRGBColorSpace as SRGBColorSpace8, Uniform as Uniform24, WebGLRenderTarget as WebGLRenderTarget15 } from "three";

// src/effects/Effect.js
import {
  BasicDepthPacking as BasicDepthPacking13,
...
var BloomEffect = class extends Effect {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      this.renderTarget.texture.type = frameBufferType;
      if (renderer.outputColorSpace === SRGBColorSpace8) {
        this.renderTarget.texture.colorSpace = SRGBColorSpace8;
      }
    }
  }
};
...
import { SRGBColorSpace as SRGBColorSpace9, Uniform as Uniform26 } from "three";
...
var BrightnessContrastEffect = class extends Effect {
  ...
  constructor({ blendFunction = BlendFunction.SRC, brightness = 0, contrast = 0 } = {}) {
    ...
    this.inputColorSpace = SRGBColorSpace9;
  }
  /**
   * The brightness.
   *
...
import { BasicDepthPacking as BasicDepthPacking14, SRGBColorSpace as SRGBColorSpace10, Uniform as Uniform29, UnsignedByteType as UnsignedByteType12, WebGLRenderTarget as WebGLRenderTarget16 } from "three";
...
var DepthOfFieldEffect = class extends Effect {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      ...
      if (renderer.outputColorSpace === SRGBColorSpace10) {
        this.renderTarget.texture.colorSpace = SRGBColorSpace10;
        this.renderTargetNear.texture.colorSpace = SRGBColorSpace10;
        this.renderTargetFar.texture.colorSpace = SRGBColorSpace10;
        this.renderTargetMasked.texture.colorSpace = SRGBColorSpace10;
      }
    }
  }
};
...
var LookupTexture = class _LookupTexture extends Data3DTexture {
  ...
  convertLinearToSRGB() {
    ...
    if (this.type === FloatType4) {
      ...
      this.colorSpace = SRGBColorSpace11;
      this.needsUpdate = true;
    } else {
...
import {
  ...
  Matrix4 as Matrix42,
  Scene as Scene2,
  SRGBColorSpace as SRGBColorSpace12,
...
var GodRaysEffect = class extends Effect {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      ...
      if (renderer.outputColorSpace === SRGBColorSpace12) {
        this.renderTargetA.texture.colorSpace = SRGBColorSpace12;
        this.renderTargetB.texture.colorSpace = SRGBColorSpace12;
        this.renderTargetLight.texture.colorSpace = SRGBColorSpace12;
      }
    }
  }
};
...
import {
  ...
  SRGBColorSpace as SRGBColorSpace13,
...
var LUT3DEffect = class extends Effect {
  ...
  constructor(lut, {
    ...
    inputColorSpace = SRGBColorSpace13
  } = {}) {
...
import {
  ...
  SRGBColorSpace as SRGBColorSpace14,
...
var SelectiveBloomEffect = class extends BloomEffect {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      this.renderTargetMasked.texture.type = frameBufferType;
      if (renderer.outputColorSpace === SRGBColorSpace14) {
        this.renderTargetMasked.texture.colorSpace = SRGBColorSpace14;
      }
    }
  }
};
...
import { SRGBColorSpace as SRGBColorSpace15, Uniform as Uniform48, Vector2 as Vector227, WebGLRenderTarget as WebGLRenderTarget22 } from "three";
...
var TiltShiftEffect = class extends Effect {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      this.renderTarget.texture.type = frameBufferType;
      if (renderer.outputColorSpace === SRGBColorSpace15) {
        this.renderTarget.texture.colorSpace = SRGBColorSpace15;
      }
    }
  }
};

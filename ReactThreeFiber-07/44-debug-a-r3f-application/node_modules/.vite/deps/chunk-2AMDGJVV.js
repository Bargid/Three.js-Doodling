...
function create(createState) {
  ...
  const useStore = (selector = api.getState, equalityFn = Object.is) => {
    const [, forceUpdate] = (0, import_react.useReducer)((c2) => c2 + 1, 0);
...
var PinchEngine = class extends Engine {
  ...
  wheel(event) {
    ...
    if (modifierKey && (Array.isArray(modifierKey) ? !modifierKey.find((k2) => event[k2]) : !event[modifierKey]))
      return;
    if (!this.state._active)
...
function useRecognizers(handlers, config = {}, gestureKey, nativeHandlers) {
  const ctrl = import_react3.default.useMemo(() => new Controller(handlers), []);
  ctrl.applyHandlers(handlers, nativeHandlers);
  ctrl.applyConfig(config, gestureKey);
  import_react3.default.useEffect(ctrl.effect.bind(ctrl));
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-2AMDGJVV.js.map
